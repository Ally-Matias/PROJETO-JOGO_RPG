...
public class Assassino extends Player{
    ...
    //Cria um Player da subclasse Assassino com todos os atributos necessários para um Assassino.
    ...
    //O assassino não ganha tanto pontos de vida ao evoluir, porém ganha mais que o mago
    ...
    //Como é um Assassino, seu método de atacar possui a capacidade de realizar dano CRÍTICO, que dobra o dano retornado normalmente
    //Como um mestre em ataques, seu ataque e dano evoluem junto com seu nível.
    ...
    //Ao selecionar Habilidades, será retornado o retorno do método da Habilidade selecionada.
