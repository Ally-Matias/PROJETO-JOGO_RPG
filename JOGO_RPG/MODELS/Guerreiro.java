...
public class Guerreiro extends Player {
    ...
    //Cria um Player da subclasse Guerreiro com todos os atributos necessários para um Guerreiro.  
    ...
    //O guerreiro ganha muitos pontos de saúde ao subir de nível
    ...
    //O método de ataque retorna um dano físico random
    ...
    public int voadora(){
      ...
      if(level<4){
        ...
        System.out.println(Color.YELLOW + "- Voce recebeu " + 4 + " de dano na queda" + Color.RESET+"\n");
