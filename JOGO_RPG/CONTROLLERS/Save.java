...
public class Save {
    ...
    //Salvar consiste na escrita de um arquivo save + o número de indice do Player a ser salvado.
    //No arquivo são escritos parametros necessários para a construção de um Player como estava no momento que foi salvo.
    ...
    //Sobrepoe com linha em branco o arquivo de acordo com o indice que é passado.
    //Como o Arraylist ja foi atualizado e seu tamanho diminuido, exclui o  arquivo que esta com o maior número.
    ...
    //Lê os arquivos de texto de save e armazena as linhas em strings que são convertidas na criação
    //de um Player com o método construtor alternativo.
